...
| Тип | Папка |
|-----|-------|
| insight | `d:/projects/ai-lab/agency-memory/memory-exports/insights/` |
| decision | `d:/projects/ai-lab/agency-memory/memory-exports/decisions/` |
| best-practice | `d:/projects/ai-lab/agency-memory/memory-exports/best-practices/` |
| playbook | `d:/projects/ai-lab/agency-memory/playbooks/` |
| template | `d:/projects/ai-lab/agency-memory/templates/` |
...
1. Выведи пользователю:
   ```
   ✅ Заметка создана:
   [Путь к файлу](d:/projects/ai-lab/agency-memory/...)
...
2. Если пользователь согласен, открой файл:
   ```bash
   code "d:/projects/ai-lab/agency-memory/memory-exports/insights/insight-название.md"
   ```
